...
- Solo se podrán utilizar las librerías que se detallan en este README. Ver [Dependencias](./desarrollo.md#dependencias)
...
Se aceptará la entrega mediante la submisión de la URL de su repositorio.
